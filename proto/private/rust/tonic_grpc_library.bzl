"""
Rust grpc library rule that supports tonic. Implementation inspired from:
...
def _tonic_rust_library_impl(ctx):
    ...
    proto_toolchain = ctx.toolchains[Label("@rules_mrobotics//proto/rust:toolchain_type")]
    ...
    compile_action_deps = depset(transform_deps(proto_toolchain.deps))
...
tonic_rust_library = rule(
    ...
    toolchains = [
        ...
        str(Label("@rules_mrobotics//proto/rust:toolchain_type")),
